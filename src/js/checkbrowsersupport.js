function checkBrowserSupport() {
	if (!NodeList.prototype.forEach) {
		document.body.innerHTML =
			'<div style="position: absolute; width: 100%; height: 100%; z-index: 50; background-color: #161616"><div style="margin: 20% auto; font-size: 2em; text-transform: uppercase; text-align: center; color: #d6d6d6;">your browser is not supported!<br>please consider to use a contemporary browser...</div></div>';
	}
}
